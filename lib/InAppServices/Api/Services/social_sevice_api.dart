...
class SocialServiceApi {
  ...
  Future<List<SocialServiceResponse>> getSocialServicesByTypeAndNotExpired(String type) async {
    final response = await http.get(Uri.parse('$baseUrl/type/$type/not-expired'));
