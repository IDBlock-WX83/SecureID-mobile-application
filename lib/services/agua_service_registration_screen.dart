...
class WaterServiceRegistrationScreen extends StatefulWidget {
  ...
  @override
  _WaterServiceRegistrationScreenState createState() =>
      _WaterServiceRegistrationScreenState();
}

class _WaterServiceRegistrationScreenState
    extends State<WaterServiceRegistrationScreen> {
  ...
  Future<void> _submitForm() async {
    ...
    final socialServiceData = {
      ...
      "socialServicesType": 'ALIMENTACION',
