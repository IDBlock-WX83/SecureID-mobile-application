...
class EducationServiceListScreen extends StatefulWidget {
  const EducationServiceListScreen({Key? key}) : super(key: key);

  @override
  _EducationServiceListScreenState createState() => _EducationServiceListScreenState();
}

class _EducationServiceListScreenState extends State<EducationServiceListScreen> {
  ...
  Future<List<SocialService>> _fetchServicios() async {
    try {
      final servicios = await socialServicesService.getSocialServicesByTypeAndNotExpired('EDUCACION');
      return servicios;
    } catch (e) {
