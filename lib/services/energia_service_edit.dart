...
class EnergyCampaignEditScreen extends StatefulWidget {
  const EnergyCampaignEditScreen({Key? key}) : super(key: key);

  @override
  _EnergyCampaignEditScreenState createState() =>
      _EnergyCampaignEditScreenState();
}

class _EnergyCampaignEditScreenState extends State<EnergyCampaignEditScreen> {
