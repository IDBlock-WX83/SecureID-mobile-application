...
class DistritoServicioSocial extends StatefulWidget {
  const DistritoServicioSocial({super.key});

  @override
  _DistritoServicioSocialState createState() => _DistritoServicioSocialState();
}

class _DistritoServicioSocialState extends State<DistritoServicioSocial> {
  ...
  Navigator.pushNamed(
    context,
    'registerenergy',  // La ruta de la siguiente vista
