...
class DistritoServicioSalud extends StatefulWidget {
  const DistritoServicioSalud({super.key});

  @override
  _DistritoServicioSaludState createState() => _DistritoServicioSaludState();
}

class _DistritoServicioSaludState extends State<DistritoServicioSalud> {
  ...
  Navigator.pushNamed(
    context,
    'registerhealth',  // La ruta de la siguiente vista
