...
class _UploadFrontDNIScreenState extends State<UploadFrontDNIScreen> {
          ...
          child: Column(
            ...
            children: [
                  ...
                  child: _dniImage == null
                      ? Column(
                          ...
                          children: const [
                            ...
                            SizedBox(height: 10),
                            Text(
                              'Parte frontal del DNI dentro del recuadro',
                              style: TextStyle(
              ...
              ElevatedButton(
                onPressed: () {
                  if (_dniImage != null) {
                    Navigator.pushNamed(context, 'upload_back_dni');
